...
public class EmployeeAssignmentMgt extends javax.swing.JFrame {
    ...
    private void loadAssignmentIds() {
        ...
        try {
            String response = ServerConnection.getInstance().sendRequest("LIST|EmployeeAssignments");
            if (response.startsWith("SUCCESS|")) {
                String[] assignments = response.substring(8).split(";");
                for (String assignment : assignments) {
                    cmbAssignmentId.addItem(assignment);
                }
            }
        } catch (Exception ex) {
    ...
    private void loadEmployeeIds() {
        ...
        try {
            ...
            if (response.startsWith("SUCCESS|")) {
                String[] employees = response.substring(8).split(";");
                for (String employee : employees) {
                    cmbEmployeeId.addItem(employee);
                }
            }
        } catch (Exception ex) {
    ...
    private void loadBranchIds() {
        ...
        try {
            ...
            if (response.startsWith("SUCCESS|")) {
                String[] branches = response.substring(8).split(";");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            String data = employeeId + "," + branchId + ","
                    + cmbAssignmentType.getSelectedItem().toString() + ","
                    + new SimpleDateFormat("yyyy-MM-dd").format(dateAssignment.getDate()) + ","
                    + txtDescription.getText() + ","
                    + cmbStatus.getSelectedItem().toString();

            String response = ServerConnection.getInstance().sendRequest("ADD|EmployeeAssignments|" + data);
            ...
            if (response.startsWith("SUCCESS|")) {
                ...
                JOptionPane.showMessageDialog(this, "Error adding assignment: " + response);
            }
        } catch (Exception ex) {
    ...
    private void btnFindActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            String response = ServerConnection.getInstance().sendRequest("FIND|EmployeeAssignments|" + assignmentId);
            ...
            if (response.startsWith("SUCCESS|")) {
                ...
                // Set branch
                int brId = Integer.parseInt(data[1]);
                ...
                cmbAssignmentType.setSelectedItem(data[2]);
                dateAssignment.setDate(java.sql.Date.valueOf(data[3]));
                txtDescription.setText(data[4]);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            String data = assignmentId + "," + employeeId + "," + branchId + ","
                    + cmbAssignmentType.getSelectedItem().toString() + ","
                    + new SimpleDateFormat("yyyy-MM-dd").format(dateAssignment.getDate()) + ","
                    + txtDescription.getText() + ","
                    + cmbStatus.getSelectedItem().toString();

            String response = ServerConnection.getInstance().sendRequest("UPDATE|EmployeeAssignments|" + data);
            ...
            if (response.startsWith("SUCCESS|")) {
                ...
                JOptionPane.showMessageDialog(this, "Error updating assignment: " + response);
            }
        } catch (Exception ex) {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            String response = ServerConnection.getInstance().sendRequest("DELETE|EmployeeAssignments|" + assignmentId);
            ...
            if (response.startsWith("SUCCESS|")) {
                ...
                JOptionPane.showMessageDialog(this, "Error deleting assignment: " + response);
            }
        } catch (Exception ex) {
